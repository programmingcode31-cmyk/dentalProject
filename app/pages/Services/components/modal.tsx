...
export const Modal: React.FC<ChildProps> = ({filter,setModal}) => {
  ...
  return (
    <div>
        <div  tabIndex={-1} aria-hidden="true" className="flex overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 max-h-full " style={{"backgroundColor":"rgba(0, 0, 0, 0.2)"}}>
